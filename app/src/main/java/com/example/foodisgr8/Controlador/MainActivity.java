...
import com.example.foodisgr8.Vista.Fragment_Sucursales;
...
public class MainActivity extends AppCompatActivity {
     ...
     */
    Fragment subPantallaInicio, subPantallaProductos, subPantallaServicios, subPantallaSucursales, subPantallaFavoritos, subPantallaSobreNosotros;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Nos permite ir al Fragment que tenemos declarado como Sucursales, donde podemos
         * encontrar la Ubicación de todas nuestras sucursales
         */
...
//-------------------------------------CREACION MENÚ------------------------------------------------
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id==R.id.itemMenu){
            Toast.makeText(this,"Módulo MENÚ completo disponible próximamente", Toast.LENGTH_LONG).show();
        ...
        if (id==R.id.itemServicios){
            Toast.makeText(this,"Módulo SERVICIOS disponible completo próximamente", Toast.LENGTH_LONG).show();
            intercambio = getSupportFragmentManager().beginTransaction();
            intercambio.replace(R.id.contenedor_Fragments, subPantallaServicios).commit();
        }
        if (id==R.id.itemUbicanos){
            Toast.makeText(this,"Módulo SUCURSALES disponible completo próximamente", Toast.LENGTH_LONG).show();
            intercambio = getSupportFragmentManager().beginTransaction();
            intercambio.replace(R.id.contenedor_Fragments, subPantallaSucursales).commit();
        }
        if (id==R.id.favorite){
            Toast.makeText(this,"Módulo FAVORITOS disponible completo próximamente", Toast.LENGTH_LONG).show();
            intercambio = getSupportFragmentManager().beginTransaction();
            intercambio.replace(R.id.contenedor_Fragments, subPantallaFavoritos).commit();
        }
        if (id==R.id.itemNosotros){
            Toast.makeText(this,"Módulo SOBRE NOSOTROS disponible completo próximamente", Toast.LENGTH_LONG).show();
            intercambio = getSupportFragmentManager().beginTransaction();
